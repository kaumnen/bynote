export function libraryAgentPrompt() {
  return [
    ...
    "Call navigate_to_notebook with an id to work on one. The tab will open that notebook and writing tools will apply to it.",
...
export function notebookAgentPrompt() {
  return [
    ...
    "If you need a different notebook, call list_notebooks, then navigate_to_notebook.",
