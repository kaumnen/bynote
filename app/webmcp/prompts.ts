export function libraryAgentPrompt() {
  return [
    ...
    "Call show_notebook with an id to work on one. The tab will show that notebook and writing tools will apply to it.",
...
export function notebookAgentPrompt() {
  return [
    ...
    "If you need a different notebook, call list_notebooks, then show_notebook.",
